...
import { Barrage, Tabbar, TabbarItem, ActionBar, ActionBarIcon, ActionBarButton, DropdownMenu, DropdownItem, Dialog, NavBar, Uploader, Toast, Cell, CellGroup, PullRefresh, List, Popup, Grid, GridItem, AddressEdit,
...
createApp(App)
  ...
  .use(ActionBar).use(ActionBarIcon).use(ActionBarButton).use(Tabbar).use(TabbarItem).use(Barrage).mount('#app')
